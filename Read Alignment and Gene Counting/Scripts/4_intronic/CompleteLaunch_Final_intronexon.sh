...
while [ $count -lt $ntime ]; do
    ...
    $script_path'ReadSampleNames_intronexon.sh' $script_path $input_path $time $reference $unaligned $aligned $includeMM $paired $unique_only $annotation $rowbarcode $output_path $sample_names
