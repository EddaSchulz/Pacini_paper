...
All the steps for scRNA-Seq read alignment and gene counting are described in the 'alignment.Rnw' script. Every step of the analysis uses R, PERL or JAVA scripts, which are stored in the "Scripts/" directory. 
...
- Drop-seq (v1.12) JAVA script from "https://github.com/broadinstitute/Drop-seq/"
