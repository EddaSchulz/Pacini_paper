...
while [ $count -lt $ntime ]; do
    ...
    $script_path'counting/counting_noASmisleading_launch.sh' $script_path $input_path $time $reference $unaligned $aligned $includeMM $paired $unique_only $annotation $rowbarcode $output_path $sample_names
